...
DROP POLICY IF EXISTS "Admins can view all ceremony registrations" ON public.ceremony_registrations;
...
DROP POLICY IF EXISTS "Admins can update ceremony registrations" ON public.ceremony_registrations;
...
DROP POLICY IF EXISTS "Admins can delete ceremony registrations" ON public.ceremony_registrations;
