        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-md">
              Un centro monastico dedicato alla pratica del Dharma, alla meditazione e alla crescita spirituale nella
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/insegnamenti" className="text-muted-foreground hover:text-saffron-500 transition-colors">
                  Insegnamenti
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-muted-foreground hover:text-saffron-500 transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/eventi" className="text-muted-foreground hover:text-saffron-500 transition-colors">
                  Eventi
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/dona" className="text-muted-foreground hover:text-saffron-500 transition-colors">
                  Dona
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-2 text-muted-foreground">
                ...
                <span>Monti San Lorenzo, 26</span>
              </div>
              <div className="flex items-center space-x-2 text-muted-foreground">
                <Phone className="h-4 w-4 text-saffron-500" />
                <span>+39 339 72 62 753</span>
              </div>
              <div className="flex items-center space-x-2 text-muted-foreground">
                <Mail className="h-4 w-4 text-saffron-500" />
                <span>taehyesunim@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
